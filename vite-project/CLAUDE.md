...
- **PostgreSQL Path**: `C:\Program Files\PostgreSQL\14\bin` (добавлен в системную PATH)
- **psql command**: Доступен как `/c/Program Files/PostgreSQL/14/bin/psql` или после перезапуска терминала просто `psql`
